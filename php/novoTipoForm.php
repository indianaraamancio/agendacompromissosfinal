...
<div id="alertas">
	...
	<form action="cadastrarNovoTipo.php" method="POST">
		...
		<div class="form-group">
		  <label class="control-label" for="Nome">Descrição do compromisso *</label>  
		<div class="col-md-8">
	...
	<form action="#" method="GET" class="formAcao">
		<div class="form-group">
			 ...
			 <input placeholder="Descrição do compromisso, ex.: aniversário" class="form-control" id="textoPesquisa" type="text" name="descPesquisa">
	...
	<table class="table">
		...
		<tr>
			<td>Pessoal</td>			
			<td>
			<form action="editarTipoCompromisso.php" method="POST"  class="formAcao">
