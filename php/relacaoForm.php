...
<div id="alertas">
	...
	<form action="#" method="GET" class="formAcao">
		<div class="form-group">
			 ...
			 <input placeholder="Descrição da relação, ex.: filho, esposa, colaborador" class="form-control" id="textoPesquisa" type="text" name="descPesquisa">
	...
	<table class="table">
		...
		<tr>
			<td>Colaborador</td>			
			<td>
			<form action="editarRelacao.php" method="POST"  class="formAcao">
