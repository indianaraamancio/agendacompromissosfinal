...
<div id="alertas">
	...
	<form action="agendarCompromisso.php" method="POST">
        ...
        <h5 class="col-md-8">Selecione a(s) pessoa(s) que fazem parte do compromisso* <button type="button"  onclick="adicionarPessoa()" class="btn btn-secondary">Adicionar pessoa</button></h5>
        ...
        <div id="pessoasDoCompromisso">  <!--Div que irá conter as pessoas do compromisso-->           
            <div class="form-group row" class="pessoas"> <!--Exemplo de nova pessoa-->   			
                    ...
                    <div class="col-md-2">			
                        <button type="button" class="botaoAcao" onclick="removerPessoa(this.id)">
