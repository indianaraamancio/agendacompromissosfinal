...
<div id="alertas">
	...
	<form action="agendarCompromisso.php" method="POST">
        ...
        <div class="row">
         <h5 class="col-md-8">Selecione a(s) pessoa(s) que fazem parte do compromisso*</h5>
        </div>			
				<select name="idPessoa[]" class="formAcao col-md-6">
					<option value="1">Roberto da Silva</option>
					<option value="2">Joana da Silva</option>
				</select>			
                <div class="col-md-2">	
                    <button type="button" class="botaoAcao" onclick="adicionarPessoa()">
		...
		<!--Adicionar dinamicamente mais pessoas-->
		<div id="maisPessoas">
		<!--Exemplo de nova pessoa-->
            <div class="form-group row" id="pessoa1">    
               			
                    <select name="idPessoa[]" class="col-md-6">
                        <option value="1">Roberto da Silva</option>
                        <option value="2">Joana da Silva</option>
                    </select>
                    ...
                    <div class="col-md-2">			
                        ...
                        <button type="button" class="botaoAcao" onclick="removerPessoa()">
	...
	</div> <!-- Fechamento div="maisPessoas" -->
	</form>
	...
	<table class="table">
		...
		<tr>
			...
			<td>20:00:00</td>
			<td>
			<form action="editarCompromiso.php" method="POST" class="formAcao">
